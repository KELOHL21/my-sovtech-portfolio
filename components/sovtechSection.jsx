...
const SovtechSection = () => {
   ...
   return ( 
      ...
      <div className="w-[90%] flex flex-col text-center m-auto mt-[0.5rem]" >
         ...
         I was inspired by SovTech`s tale when browsing their website. A company founded in a garage that has grown to over 300 employees, creating top engineering experts that offer a world-class platform  for growing businesses is defintely something to catch ones eye. SovTech is committed to their values. As well as their ambitions. All of those successful qualities resonated with me. And encouraged me to choose SovTech. This company, I believe, has the skills and expertise to push me to become not only a better Developer, but also a better person. Being one of Africa`s finest custom software development companies simplifies the decision to work with. I still have a lot to learn, but if given the chance, I am confident that I can benefit greatly from every single individual at Sovtech and do amazing things.
